...
public class LoginFunctionality {
	...
	public void iniciar() {
		...
		System.setProperty("webdriver.driver.chrome",
				"D:\\Calisto\\Analista de QA\\Portfólio\\Selenium-with-java\\sauceDemoRed_standard_user\\drivers\\chrome\\chromedriver-win64-119\\chromedriver-win64\\chromedriver.exe");
	...
	public void TC01_loginSuccessFully() {
		...
		assertEquals(produtos, driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div/div[1]/div[3]/div")).getText());
	}
	...
	public void TC02_invalidUsername() {
		...
		assertEquals(errorMessage1, driver.findElement(By.xpath("/html/body/div[2]/div[1]/div/div/form/h3")).getText());
	...
	public void TC03_invalidPassword() {
		...
		assertEquals(errorMessage1,
				driver.findElement(By.xpath("/html/body/div[2]/div[1]/div/div/form/h3")).getText());
